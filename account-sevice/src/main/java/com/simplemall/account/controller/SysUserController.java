...
import com.simplemall.account.service.ISysUserRoleService;
...
import com.simplemall.micro.serv.common.bean.account.SysUserRole;
...
import com.simplemall.micro.serv.common.util.ImportExcelUtil;
...
import com.simplemall.micro.serv.common.vo.SysUserRoleVO;
...
public class SysUserController {
    ...
    public ModelAndView exportXls(SysUser sysUser, HttpServletRequest request) {
       ...
       if(!oConvertUtils.isEmpty(selections)){
        ...
        ExportParams exportParams = new ExportParams("用户列表数据", "导出人:"+"", "导出信息");
	...
	public Result<JSONObject> userRegister(@RequestBody JSONObject jsonObject, SysUser user) {
		...
		Object code = JedisUtil.STRINGS.get(phone);
	...
	public Result<Map<String, String>> phoneVerification(@RequestBody JSONObject jsonObject) {
		...
		//设置有效时间
        JedisUtil.STRINGS.setEx(phone, 600,smscode);
	...
	public Result<SysUser> passwordChange(@RequestParam(name="username") String username,
        ...
        Object object= JedisUtil.STRINGS.get(phone);
        if(null==object) {
