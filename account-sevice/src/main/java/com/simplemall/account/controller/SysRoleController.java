...
import com.simplemall.account.service.ISysPermissionService;
import com.simplemall.account.service.ISysRolePermissionService;
import com.simplemall.account.service.ISysRoleService;
import com.simplemall.micro.serv.common.bean.Result;
import com.simplemall.micro.serv.common.bean.account.SysPermission;
import com.simplemall.micro.serv.common.bean.account.SysRole;
import com.simplemall.micro.serv.common.bean.account.SysRolePermission;
...
public class SysRoleController {
	...
	public ModelAndView exportXls(SysRole sysRole, HttpServletRequest request) {
		...
		mv.addObject(NormalExcelConstants.PARAMS,new ExportParams("角色列表数据","导出人:"+"","导出信息"));
