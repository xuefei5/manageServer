package com.simplemall.micro.serv.common.bean.order.model;
...
public class SysPermission implements Serializable {
	...
	public SysPermission(int index) {
			this.id = "9502685863ab87f0ad1134142788a386";
			this.name="用户管理";
			this.component="system/UserList";
			this.componentName="system-UserList";
			this.url="/system/UserList";
			this.icon="home";
			this.menuType=0;
			this.sortNo=0.0;
			this.ruleFlag=0;
